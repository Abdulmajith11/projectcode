...
import commentImg from "../assets/all-images/abdul.png";
              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    <h6 className=" fw-bold">Abdul </h6>
                    <p className="section__description mb-0">11 Nov, 2023</p>
                    <p className="section__description">
                      Contact Us any time we are here to help you.. 
                    </p>
